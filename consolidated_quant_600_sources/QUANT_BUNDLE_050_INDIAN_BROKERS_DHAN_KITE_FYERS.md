# ⚡ [QUANT-SOURCE-050] Consolidated Quant & Algo Trading Repositories
**Category**: `INDIAN_BROKERS_DHAN_KITE_FYERS` | **Repositories in this Source**: 3
**Generated**: QUANT_BUNDLE_050_INDIAN_BROKERS_DHAN_KITE_FYERS.md | **Target**: NotebookLM 290+ Quant Code Brain

---

## [1/3] Repository: dhanhq-client (`DISC-630`)
- **Full Name**: `shubhamtaywade82/dhanhq-client`
- **Description**: 
- **GitHub Stars**: 4
...
## [2/3] Repository: DhanHQ-java (`DISC-631`)
- **Full Name**: `karthiks/DhanHQ-java`
- **Description**: Unofficial DhanHQ SDK for JVM platform
- **GitHub Stars**: 4
- **Source Pool**: `more_github_repos.json`
...
## [3/3] Repository: dhanhq-sdk (`DISC-632`)
- **Full Name**: `shubhamtaywade82/dhanhq-sdk`
- **Description**: 
- **GitHub Stars**: 1
- **Source Pool**: `more_github_repos.json`
