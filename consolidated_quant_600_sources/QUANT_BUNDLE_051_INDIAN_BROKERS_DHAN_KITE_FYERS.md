# ⚡ [QUANT-SOURCE-051] Consolidated Quant & Algo Trading Repositories
**Category**: `INDIAN_BROKERS_DHAN_KITE_FYERS` | **Repositories in this Source**: 3
**Generated**: QUANT_BUNDLE_051_INDIAN_BROKERS_DHAN_KITE_FYERS.md | **Target**: NotebookLM 290+ Quant Code Brain

---

## [1/3] Repository: godhanhq (`DISC-634`)
- **Full Name**: `tradewithcanvas/godhanhq`
- **Description**: Open source Go SDK for the DhanHQ API for both individuals and partners.
- **GitHub Stars**: 1
...
## [2/3] Repository: AlgorithmicTrading (`DISC-635`)
- **Full Name**: `Sanjay96513/AlgorithmicTrading`
- **Description**: A comprehensive algorithmic trading system designed to automate trading strategies with advanced risk management and performance analytics. This project involves migrating from DhanHQ API to Fyers API v3 while building a robust, scalable infrastructure capable of handling high-frequency trading requirements.
- **GitHub Stars**: 1
- **Source Pool**: `more_github_repos.json`
...
## [3/3] Repository: Dhan (`DISC-636`)
- **Full Name**: `faizjameel2317-droid/Dhan`
- **Description**: Dhanhq
- **GitHub Stars**: 0
- **Source Pool**: `more_github_repos.json`
