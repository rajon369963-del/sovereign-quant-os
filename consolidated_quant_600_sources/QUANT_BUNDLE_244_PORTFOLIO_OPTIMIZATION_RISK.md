# ⚡ [QUANT-SOURCE-244] Consolidated Quant & Algo Trading Repositories
**Category**: `PORTFOLIO_OPTIMIZATION_RISK` | **Repositories in this Source**: 3
**Generated**: QUANT_BUNDLE_244_PORTFOLIO_OPTIMIZATION_RISK.md | **Target**: NotebookLM 290+ Quant Code Brain

---

## [1/3] Repository: portfolioopt (`DISC-533`)
- **Full Name**: `czielinski/portfolioopt`
...
## [2/3] Repository: tyumex-trading-terminal (`DISC-588`)
- **Full Name**: `Tyumex/tyumex-trading-terminal`
- **Description**: Windows order-flow trading terminal: footprint charts, Renko/Range, bar replay, risk management and MetaTrader 4/5 trading. Binance, Hyperliquid and CME/MOEX data. Try the live browser demo.
- **GitHub Stars**: 12
...
## [3/3] Repository: markowitz-portfolio-optimization (`DISC-614`)
- **Full Name**: `chaitjo/markowitz-portfolio-optimization`
- **Description**: Markowitz portfolio optimization on synthetic and real stocks
- **GitHub Stars**: 79
- **Source Pool**: `more_github_repos.json`
