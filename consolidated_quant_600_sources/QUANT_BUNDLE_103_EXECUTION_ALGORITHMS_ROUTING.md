# ⚡ [QUANT-SOURCE-103] Consolidated Quant & Algo Trading Repositories
**Category**: `EXECUTION_ALGORITHMS_ROUTING` | **Repositories in this Source**: 3
**Generated**: QUANT_BUNDLE_103_EXECUTION_ALGORITHMS_ROUTING.md | **Target**: NotebookLM 290+ Quant Code Brain

---

## [1/3] Repository: openalgo (`WHEEL_openalgo`)
- **Full Name**: `openalgo`
...
## [2/3] Repository: algotradersonline (`VAULT_IN-QUANT-024_TanmayLodha__algotradersonline`)
- **Full Name**: `IN-QUANT-024_TanmayLodha__algotradersonline`
- **Description**: 
- **GitHub Stars**: 0
...
#### File: `backend/optionchain/__init__.py`
```python

```

#### File: `backend/optionchain/migrations/__init__.py`
```python
...
#### File: `backend/registerLogin/__init__.py`
```python

```

#### File: `backend/strategiesAPI/__init__.py`
```python
...
## [3/3] Repository: openalgo-trading (`VAULT_IN-QUANT-035_Aniekanetim__openalgo-trading`)
- **Full Name**: `IN-QUANT-035_Aniekanetim__openalgo-trading`
- **Description**: 
- **GitHub Stars**: 0
- **Source Pool**: `indian_quant_vault`
...
#### File: `broker/firstock/__init__.py`
```python
