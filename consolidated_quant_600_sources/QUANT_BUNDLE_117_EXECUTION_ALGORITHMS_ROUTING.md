# ⚡ [QUANT-SOURCE-117] Consolidated Quant & Algo Trading Repositories
**Category**: `EXECUTION_ALGORITHMS_ROUTING` | **Repositories in this Source**: 3
**Generated**: QUANT_BUNDLE_117_EXECUTION_ALGORITHMS_ROUTING.md | **Target**: NotebookLM 290+ Quant Code Brain

---

## [1/3] Repository: Vibe-Trading (`DISC-507`)
- **Full Name**: `HKUDS/Vibe-Trading`
...
## [2/3] Repository: algotrading (`DISC-518`)
- **Full Name**: `ivopetiz/algotrading`
...
## [3/3] Repository: tribeca (`DISC-554`)
- **Full Name**: `michaelgrosner/tribeca`
