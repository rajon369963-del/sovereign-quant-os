# ⚡ [QUANT-SOURCE-118] Consolidated Quant & Algo Trading Repositories
**Category**: `EXECUTION_ALGORITHMS_ROUTING` | **Repositories in this Source**: 3
**Generated**: QUANT_BUNDLE_118_EXECUTION_ALGORITHMS_ROUTING.md | **Target**: NotebookLM 290+ Quant Code Brain

---

## [1/3] Repository: Krypto-trading-bot (`DISC-555`)
- **Full Name**: `ctubio/Krypto-trading-bot`
...
## [2/3] Repository: v1-contracts (`DISC-559`)
- **Full Name**: `Uniswap/v1-contracts`
- **Description**: 🐍Uniswap V1 smart contracts
- **GitHub Stars**: 532
- **Source Pool**: `more_github_repos.json`
...
## [3/3] Repository: Pumpfun-Volume-Market-Maker-Bot (`DISC-562`)
- **Full Name**: `cutupdev/Pumpfun-Volume-Market-Maker-Bot`
- **Description**: Solana pumpfun volume bot and market maker
- **GitHub Stars**: 167
- **Source Pool**: `more_github_repos.json`
