# ⚡ [QUANT-SOURCE-070] Consolidated Quant & Algo Trading Repositories
**Category**: `QUANT_SYSTEMS_INFRASTRUCTURE` | **Repositories in this Source**: 3
**Generated**: QUANT_BUNDLE_070_QUANT_SYSTEMS_INFRASTRUCTURE.md | **Target**: NotebookLM 290+ Quant Code Brain

---

## [1/3] Repository: CREDIT-CARD-FRAUD-DETECTION-1 (`WHEEL_CREDIT-CARD-FRAUD-DETECTION-1`)
- **Full Name**: `CREDIT-CARD-FRAUD-DETECTION-1`
- **Description**: 
- **GitHub Stars**: 0
...
## [2/3] Repository: FinNLP (`WHEEL_FinNLP`)
- **Full Name**: `FinNLP`
- **Description**: 
- **GitHub Stars**: 0
- **Source Pool**: `cloned_trading_wheels`
...
#### File: `finnlp/data_sources/__init__.py`
```python

```

#### File: `finnlp/data_sources/sec_filings/prepline_sec_filings/api/__init__.py`
```python

```

#### File: `finnlp/data_sources/social_media/__init__.py`
```python

```

#### File: `finnlp/data_sources/news/__init__.py`
```python

```

#### File: `finnlp/data_sources/trends/__init__.py`
```python

```

#### File: `finnlp/data_sources/trends/baidu.py`
```python
...
## [3/3] Repository: Market-Impact-Model (`WHEEL_Market-Impact-Model`)
- **Full Name**: `Market-Impact-Model`
- **Description**: 
- **GitHub Stars**: 0
- **Source Pool**: `cloned_trading_wheels`
...
### Core Implementation Code & Architecture
#### File: `Tests/impactUtils/__init__.py`
```python

```

#### File: `Tests/preProcessingTests/__init__.py`
```python

```

#### File: `Tests/taq/__init__.py`
```python

```

#### File: `impactUtils/VWAP/__init__.py`
```python
from .VWAP import VWAP
```

#### File: `Tests/preProcessingTests/Test_ArrivalPrice.py`
```python
# same as FirstPriceBuckets
```

#### File: `impactUtils/TickTest/__init__.py`
```python
