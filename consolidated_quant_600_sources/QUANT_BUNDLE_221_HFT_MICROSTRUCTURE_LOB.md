# ⚡ [QUANT-SOURCE-221] Consolidated Quant & Algo Trading Repositories
**Category**: `HFT_MICROSTRUCTURE_LOB` | **Repositories in this Source**: 3
**Generated**: QUANT_BUNDLE_221_HFT_MICROSTRUCTURE_LOB.md | **Target**: NotebookLM 290+ Quant Code Brain

---

## [1/3] Repository: ctc-executioner (`DISC-561`)
- **Full Name**: `mjuchli/ctc-executioner`
- **Description**: Master Thesis: Limit order placement with Reinforcement Learning 
- **GitHub Stars**: 179
...
## [2/3] Repository: docker_grid_trader (`DISC-563`)
- **Full Name**: `tiansin/docker_grid_trader`
- **Description**: A grid trading strategy and trading-bot for Binance Exchange.币安交易所网格交易套利策略.稳定量化交易策略
- **GitHub Stars**: 110
- **Source Pool**: `more_github_repos.json`
...
## [3/3] Repository: market-maker-bot (`DISC-564`)
- **Full Name**: `ExchangeUnion/market-maker-bot`
- **Description**: MM Bot for OpenDEX. Make profits via arbitrage between OpenDEX and a connected CEX account like Binance 🤖
- **GitHub Stars**: 105
- **Source Pool**: `more_github_repos.json`
