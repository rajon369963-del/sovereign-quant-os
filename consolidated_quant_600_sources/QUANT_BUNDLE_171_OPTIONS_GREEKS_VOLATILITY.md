# ⚡ [QUANT-SOURCE-171] Consolidated Quant & Algo Trading Repositories
**Category**: `OPTIONS_GREEKS_VOLATILITY` | **Repositories in this Source**: 3
**Generated**: QUANT_BUNDLE_171_OPTIONS_GREEKS_VOLATILITY.md | **Target**: NotebookLM 290+ Quant Code Brain

---

## [1/3] Repository: options-implied-probability (`DISC-665`)
- **Full Name**: `Open-Lemma/options-implied-probability`
- **Description**: OIPD computes the probabilities of an asset's future price as implied by the options market.
- **GitHub Stars**: 354
...
## [2/3] Repository: GraphVega (`DISC-666`)
- **Full Name**: `rahuljoshi44/GraphVega`
...
## [3/3] Repository: optionmatrix (`DISC-667`)
- **Full Name**: `AnthonyBradford/optionmatrix`
- **Description**: Financial Derivatives Calculator with 171+ Models (Options Calculator)
- **GitHub Stars**: 251
- **Source Pool**: `more_github_repos.json`
