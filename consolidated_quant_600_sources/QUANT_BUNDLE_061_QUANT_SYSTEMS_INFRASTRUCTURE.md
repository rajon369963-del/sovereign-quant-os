# ⚡ [QUANT-SOURCE-061] Consolidated Quant & Algo Trading Repositories
**Category**: `QUANT_SYSTEMS_INFRASTRUCTURE` | **Repositories in this Source**: 3
**Generated**: QUANT_BUNDLE_061_QUANT_SYSTEMS_INFRASTRUCTURE.md | **Target**: NotebookLM 290+ Quant Code Brain

---

## [1/3] Repository: pyPMClient (`VAULT_IN-QUANT-016_paytmmoney__pyPMClient`)
- **Full Name**: `IN-QUANT-016_paytmmoney__pyPMClient`
- **Description**: 
- **GitHub Stars**: 0
...
#### File: `pmClient/__init__.py`
```python
from .pmClient import PMClient
```

#### File: `pmClient/epochConverterUtil.py`
```python
import datetime
...
## [2/3] Repository: vnpy (`WHEEL_vnpy`)
- **Full Name**: `vnpy`
- **Description**: 
- **GitHub Stars**: 0
...
### Core Implementation Code & Architecture
#### File: `vnpy/trader/__init__.py`
```python

```

#### File: `vnpy/trader/ui/ico/__init__.py`
```python

```

#### File: `vnpy/alpha/dataset/datasets/__init__.py`
```python

```

#### File: `vnpy/alpha/model/models/__init__.py`
```python

```

#### File: `vnpy/alpha/strategy/strategies/__init__.py`
```python

```

#### File: `vnpy/alpha/model/__init__.py`
```python
...
## [3/3] Repository: uniBroker (`VAULT_IN-QUANT-027_SU1199__uniBroker`)
- **Full Name**: `IN-QUANT-027_SU1199__uniBroker`
- **Description**: 
- **GitHub Stars**: 0
- **Source Pool**: `indian_quant_vault`
