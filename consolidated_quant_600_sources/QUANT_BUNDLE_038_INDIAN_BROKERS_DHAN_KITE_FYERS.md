# ⚡ [QUANT-SOURCE-038] Consolidated Quant & Algo Trading Repositories
**Category**: `INDIAN_BROKERS_DHAN_KITE_FYERS` | **Repositories in this Source**: 3
**Generated**: QUANT_BUNDLE_038_INDIAN_BROKERS_DHAN_KITE_FYERS.md | **Target**: NotebookLM 290+ Quant Code Brain

---

## [1/3] Repository: daily_stock_analysis (`PHASE4-QUANT-101`)
- **Full Name**: `PHASE4-QUANT-101_ZhuLinsen__daily_stock_analysis`
...
#### File: `apps/dsa-web/tsconfig.json`
```python
{
  "files": [],
  "references": [
...
#### File: `src/agent/strategies/strategy_agent.py`
```python
...
## [2/3] Repository: financial_response_spread_year (`PHASE4-QUANT-128`)
- **Full Name**: `PHASE4-QUANT-128_juanhenao21__financial_response_spread_year`
- **Description**: Price response function and spread impact analysis in correlated financial markets
- **GitHub Stars**: 15
- **Source Pool**: `phase4_quant_wheels_100`
...
### Core Implementation Code & Architecture
#### File: `project/taq_avg_responses_physical/taq_algorithms/__init__.py`
```python

```

#### File: `project/taq_responses_trade_shift/taq_algorithms/__init__.py`
```python

```

#### File: `project/taq_physical_shift/taq_algorithms/__init__.py`
```python

```

#### File: `project/taq_statistics/taq_algorithms/__init__.py`
```python

```

#### File: `project/taq_avg_spread/taq_algorithms/__init__.py`
```python

```

#### File: `project/taq_responses_physical/taq_algorithms/__init__.py`
```python
...
## [3/3] Repository: dhan-tradingview-chrome-extension (`PHASE4-QUANT-131`)
- **Full Name**: `PHASE4-QUANT-131_vinay-sd17__dhan-tradingview-chrome-extension`
- **Description**: DhanHQ Tradingview Chrome Extension - Roadmap Repository
- **GitHub Stars**: 3
- **Source Pool**: `phase4_quant_wheels_100`
