# ⚡ [QUANT-SOURCE-083] Consolidated Quant & Algo Trading Repositories
**Category**: `QUANT_SYSTEMS_INFRASTRUCTURE` | **Repositories in this Source**: 3
**Generated**: QUANT_BUNDLE_083_QUANT_SYSTEMS_INFRASTRUCTURE.md | **Target**: NotebookLM 290+ Quant Code Brain

---

## [1/3] Repository: quickfix (`WHEEL_quickfix`)
- **Full Name**: `quickfix`
- **Description**: 
- **GitHub Stars**: 0
...
#### File: `src/C++/test/TestHelper.cpp`
```python
#ifdef _MSC_VER
#include "stdafx.h"
#else
...
#### File: `src/python/test/MessageStoreTestCase.py`
```python
import quickfix as fix
...
#### File: `src/python/test/FieldBaseTestCase.py`
```python
import quickfix as fix
import unittest
...
## [2/3] Repository: ripgrep (`WHEEL_ripgrep`)
- **Full Name**: `ripgrep`
- **Description**: 
- **GitHub Stars**: 0
- **Source Pool**: `cloned_trading_wheels`
...
#### File: `crates/core/flags/complete/mod.rs`
```python
/*!
...
## [3/3] Repository: roq-api (`WHEEL_roq-api`)
- **Full Name**: `roq-api`
- **Description**: C++ interfaces used to communicate with Roq's market gateways.
- **GitHub Stars**: 517
- **Source Pool**: `cloned_trading_wheels`
