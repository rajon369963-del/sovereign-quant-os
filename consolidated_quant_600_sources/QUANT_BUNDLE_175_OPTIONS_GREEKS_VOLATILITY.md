# ⚡ [QUANT-SOURCE-175] Consolidated Quant & Algo Trading Repositories
**Category**: `OPTIONS_GREEKS_VOLATILITY` | **Repositories in this Source**: 3
**Generated**: QUANT_BUNDLE_175_OPTIONS_GREEKS_VOLATILITY.md | **Target**: NotebookLM 290+ Quant Code Brain

---

## [1/3] Repository: Binary-Option-Pricing (`DISC-680`)
- **Full Name**: `xinyexu/Binary-Option-Pricing`
- **Description**: Currency Binary Option Pricing with 3 methods and implied smile
- **GitHub Stars**: 28
...
## [2/3] Repository: PutPremiumProcessor (`DISC-684`)
- **Full Name**: `GrahamboJangles/PutPremiumProcessor`
- **Description**: PutPremiumProcessor is a Python option screener with a custom formula to score options based on their risk to reward. I created this to find puts that pay good premium for the risk.
- **GitHub Stars**: 23
- **Source Pool**: `more_github_repos.json`
...
## [3/3] Repository: OptionsProfitCalculator (`DISC-686`)
- **Full Name**: `Joas3068/OptionsProfitCalculator`
- **Description**: Options P/L in React
- **GitHub Stars**: 23
- **Source Pool**: `more_github_repos.json`
