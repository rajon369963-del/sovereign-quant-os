# ⚡ [QUANT-SOURCE-119] Consolidated Quant & Algo Trading Repositories
**Category**: `EXECUTION_ALGORITHMS_ROUTING` | **Repositories in this Source**: 3
**Generated**: QUANT_BUNDLE_119_EXECUTION_ALGORITHMS_ROUTING.md | **Target**: NotebookLM 290+ Quant Code Brain

---

## [1/3] Repository: nombot (`DISC-566`)
- **Full Name**: `karma0/nombot`
...
## [2/3] Repository: cex-withdrawal-bot (`DISC-573`)
- **Full Name**: `exileqeq/cex-withdrawal-bot`
- **Description**: Automated output of tokens to any networks from binance, kraken, coinbase, mexc, , gate, bybit 
- **GitHub Stars**: 33
- **Source Pool**: `more_github_repos.json`
...
## [3/3] Repository: amm-frontrun-bot (`DISC-576`)
- **Full Name**: `sunshineioxzc/amm-frontrun-bot`
- **Description**: Automated market maker frontrunning bot for common DEXs 
- **GitHub Stars**: 24
- **Source Pool**: `more_github_repos.json`
