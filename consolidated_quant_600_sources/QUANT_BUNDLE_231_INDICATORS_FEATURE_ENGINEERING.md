# ⚡ [QUANT-SOURCE-231] Consolidated Quant & Algo Trading Repositories
**Category**: `INDICATORS_FEATURE_ENGINEERING` | **Repositories in this Source**: 3
**Generated**: QUANT_BUNDLE_231_INDICATORS_FEATURE_ENGINEERING.md | **Target**: NotebookLM 290+ Quant Code Brain

---

## [1/3] Repository: Surge (`DISC-583`)
- **Full Name**: `SurgeDetect/Surge`
- **Description**: Robinhood crypto breakout-quality filter that ranks participation, depth growth, refill, and dispersion.
- **GitHub Stars**: 22
...
## [2/3] Repository: python-tradingview-ta (`DISC-722`)
- **Full Name**: `AnalyzerREST/python-tradingview-ta`
...
## [3/3] Repository: Binance-Futures-Trading-Bot (`DISC-729`)
- **Full Name**: `conor19w/Binance-Futures-Trading-Bot`
- **Description**: A Technical Analysis Bot that trades leveraged USDT futures markets on Binance.
- **GitHub Stars**: 661
- **Source Pool**: `more_github_repos.json`
