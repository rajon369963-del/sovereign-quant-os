#!/usr/bin/env python3
"""Mechanism-sensitive receipt verifier court for Quant Issue #49.

The previous on-disk signed-receipt mutation pattern caused early canonical payload
and cryptographic signature failure before the target validator stage could run.
