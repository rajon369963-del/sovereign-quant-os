...
# Insert payload into textarea and click Insert
js_insert = f"""(() => {{
...
print("Insert result:", run_js(js_insert))

# Wait and check sources
time.sleep(3)
js_check = """(() => {
...
print("Sources after insert:", run_js(js_check))
