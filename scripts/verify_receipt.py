...
DEFAULT_BENCH_FILE = "scripts/quant_benchmark_results.json"
BENCH_SCRIPT_REL = "scripts/benchmark_quant_risk_gate.py"
WORKLOAD_METRIC_KEY = "throughput_checks_sec"
MIN_THROUGHPUT_X86 = 1_000_000
MIN_THROUGHPUT_ARM = 2_000_000
CHECK_PITCH = False
